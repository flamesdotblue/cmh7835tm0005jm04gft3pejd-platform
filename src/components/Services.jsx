...
const services = [
  { title: "Clean Cut", desc: "Sharp lines, tailored to your features.", price: "$30" },
  { title: "Fade + Style", desc: "Seamless gradients with matte finish.", price: "$40" },
  { title: "Beard Trim", desc: "Defined shape with precise detailing.", price: "$20" },
];
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex items-end justify-between gap-8">
          <div>
            ...
            <p className="mt-3 text-white/70 max-w-xl">Minimal menu. Maximum focus. Every service is performed with precision and care.</p>
          </div>
